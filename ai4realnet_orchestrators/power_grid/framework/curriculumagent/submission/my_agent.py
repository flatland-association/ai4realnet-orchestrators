...
class MyAgent(BaseAgent):
    ...
    def __get_tf_actions(self, obs: grid2op.Observation.BaseObservation):
            ...
            if "timestep" in f.structured_input_signature[1]:
                kwargs["timestep"] = tf.convert_to_tensor(0, dtype=tf.int64)
            if "is_training" in f.structured_input_signature[1]:
                kwargs["is_training"] = tf.convert_to_tensor(False)
