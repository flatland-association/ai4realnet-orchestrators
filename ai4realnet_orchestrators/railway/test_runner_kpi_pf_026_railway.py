...
class TestRunner_KPI_PF_026_Railway(TestRunner):
  ...
  def run_scenario(self, scenario_id: str, submission_id: str):
    ...
    sum_normalized_reward = df_trains_rewards_dones_Infos["reward"].sum()
    print(sum_normalized_reward)

    return {
      'sum_normalized_reward': sum_normalized_reward,
  ...
  def load_scenario_data(scenario_id: str) -> str:
    return {
      '5a60713d-01f2-4d32-9867-21904629e254': "Test_01/Level_0.pkl",
