...
def test_submit(submission_name="S046"):
    ...
    submitted = fab.submissions_post(
        SubmissionsPostRequest(benchmark_id=benchmark_id,
...
def _get_test_runner():
    ...
    test_runner = railway_orchestrator.test_runners["98ceb866-5479-47e6-a735-81292de8ca65"]
    ...
    # test_runner = railway_orchestrator.test_runners["e075d4a7-5cda-4d3c-83ac-69a0db1d74dd"]
    return test_runner
