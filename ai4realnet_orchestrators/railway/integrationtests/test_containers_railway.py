...
def test_runner_kpi_pf_026_railway():
  ...
  submission_data_url = "ghcr.io/flatland-association/flatland-baselines:chenkins-patch-1"  # Celery: passed in "submission_data_url" key of kwargs when Celery task is submitted
